...
function singupAction(prevFormState, formData) {
    ...
    if(!isEqualToOtherValue(password, confirmPassword)) {
      errors.push('Please, the password must match.');
    }
...
export default function Signup() {
  const [
    ...
    formAction,
    pending,
  ] = useActionState(singupAction, { errors: null });
  return (
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="other"
            defaultChecked={formState.values?.acquisitionChannel.includes('other')}  
          />
