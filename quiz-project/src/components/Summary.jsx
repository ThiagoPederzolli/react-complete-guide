...
function Summary({ userAnswers }) {
    ...
    const corretPercentage = Math.round((correctAnswers.length / userAnswers.length) * 100);
    // const wrongPercentage = Math.round((wrongAnswers.length / userAnswers.length) * 100);
    const wrongPercentage = 100 - skippedPercentage - corretPercentage;
    return (
        <div id="summary">
            ...
            <div id="summary-stats">
                ...
                <p>
                    <span className="number">{corretPercentage}%</span>
